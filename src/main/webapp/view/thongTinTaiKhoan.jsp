...
<head>
    ...
    <link rel="stylesheet" href="static/css/thongTinTaiKhoan.css">
...
<div class="btn-cap-nhat">
    <button class = "btnCapNhat btnCapNhatThongTin">Cập nhật</button>
</div>
<!-- footer -->
<div class="content-7">
    <div class="footer">
...
<script src="static/js/thongTinTaiKhoan.js" ></script>
